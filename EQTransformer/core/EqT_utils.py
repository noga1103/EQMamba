...
class MambaSSM(Layer):
    ...
    def call(self, x, delta, B, C, D):
        ...
        h = ag__.converted_call(ag__.ld(tf).scan, (ag__.autograph_artifact(lambda h_prev, x_t: ag__.converted_call(ag__.ld(tf).matmul, (ag__.ld(x_t), ag__.converted_call(ag__.ld(tf).transpose, (ag__.ld(B), [0, 2, 1]), None, fscope)), None, fscope) + ag__.converted_call(ag__.ld(tf).matmul, (ag__.ld(h_prev), ag__.converted_call(ag__.ld(tf).exp, (ag__.ld(delta) * ag__.ld(self).A,), None, fscope)), None, fscope)), ag__.ld(x)), dict(initializer=ag__.converted_call(ag__.ld(tf).zeros, ((ag__.converted_call(ag__.ld(tf).shape, (ag__.ld(x),), None, fscope)[0], ag__.converted_call(ag__.ld(tf).shape, (ag__.ld(x),), None, fscope)[-1]),), None, fscope)), fscope)
...
class cred2():
    ...
    Returns
    ----------
        The compiled model: keras model
